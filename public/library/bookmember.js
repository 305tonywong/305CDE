...
.controller('searchController', ['$location', 'searchFormData', 'bookData', function($location, searchFormData, bookData) {
...
}]).controller('bookListController', ['bookData', 'bookResourceFactory', '$scope', '$window', '$http', function(bookData, bookResourceFactory, $scope, $window, $http) {
  var mv = this;
  ...
  $scope.additem = function(index){
    var todo = $scope.bookListCtr.searchResults[index].id;
    var dataObj = {
    image: $scope.bookListCtr.searchResults[index].volumeInfo.imageLinks,
    url : $scope.bookListCtr.searchResults[index].volumeInfo.infoLink,
    title : $scope.bookListCtr.searchResults[index].volumeInfo.title,
    author: $scope.bookListCtr.searchResults[index].volumeInfo.authors
    };
    $http.put('/addfavlist/' + todo, dataObj);
    $window.alert('The book is added to the favourite list.');
